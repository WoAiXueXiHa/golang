...
![image-20260818172813587](https://gitee.com/binary-whispers/pic/raw/master///20260818172816243.png)
...
![image-20260818173836560](https://gitee.com/binary-whispers/pic/raw/master///20260818173838589.png)

#### N : 1 和 1 : 1 设计

N个协程绑定1个线程，优点就是**协程在用户态线程即完成切换，不会陷入到内核态，这种切换非常的轻量快速**。但也有很大的缺点，1个进程的所有协程都绑定在1个线程上，**无法利用多个 CPU，可能会阻塞**

![image-20260818174931805](https://gitee.com/binary-whispers/pic/raw/master///20260818174934242.png)

1：1的设计和多线程没有区别，切换代价大

#### M : N 设计

![image-20260818175053485](https://gitee.com/binary-whispers/pic/raw/master///20260818175055479.png)

这种设计就依赖协程调度器的性能了

所以，最终的 GMP 模型图长这样：

![image-20260818180434266](https://gitee.com/binary-whispers/pic/raw/master///20260818180436867.png)
...
![image-20260818191906786](https://gitee.com/binary-whispers/pic/raw/master///20260818191909031.png)
...
![image-20260820114731786](https://gitee.com/binary-whispers/pic/raw/master///20260820114733244.png)

### 2.2 G 运行完成后

M1 上的 G1 运行完成后（调用 `goexit()`），M1 上运行的 goroutine 会切换成 g0，g0 负责调度协程的切换（运行`schedule()`函数），从 M1 上 P 的本地队列获取 G2 去执行（函数`execute()`）

![image-20260820114717863](https://gitee.com/binary-whispers/pic/raw/master///20260820114719427.png)
...
![image-20260820114655379](https://gitee.com/binary-whispers/pic/raw/master///20260820114657222.png)
...
![image-20260820114635508](https://gitee.com/binary-whispers/pic/raw/master///20260820114637400.png)
...
![image-20260820114608879](https://gitee.com/binary-whispers/pic/raw/master///20260820114610787.png)

### 2.6 G 发生系统调用时

如果 G 发生系统调用进入阻塞，所在的 M 也会阻塞，需要进入内核态等待系统资源，和 M 绑定的 P 会寻找空闲的 M 执行

![image-20260820114550733](https://gitee.com/binary-whispers/pic/raw/master///20260820114552617.png)
...
![image-20260820114517321](https://gitee.com/binary-whispers/pic/raw/master///20260820114520047.png)
...
![image-20260820151951728](https://gitee.com/binary-whispers/pic/raw/master///20260820151956074.png)
...
![image-20260821095253707](https://gitee.com/binary-whispers/pic/raw/master///20260821095256172.png)
